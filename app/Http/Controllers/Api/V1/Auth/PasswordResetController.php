...
class PasswordResetController extends Controller
{
    public function reset_password_request(Request $request)
    {
        ...
        if (isset($customer)) {
            ...
            return response()->json(['message' => trans('custom.email_sent')], 200);
        }
        return response()->json(['errors' => [
            ['code' => 'not-found', 'message' => trans('custom.email_not_found')]
        ]], 404);
    }
    ...
    public function reset_password_submit(Request $request)
    {
        ...
        if (isset($data)) {
            ...
            return response()->json(['errors' => [
                ['code' => 'mismatch', 'message' => trans('custom.password_not_matched')]
            ]], 401);
        }
        return response()->json(['errors' => [
            ['code' => 'invalid', 'message' => trans('custom.invalid_token')]
