                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('admin.orders.list',['pending'])}}'">
                        <div class="media-body">
                            ...
                            <span class="card-title h3">{{\App\Model\Order::where(['order_status'=>'pending'])->whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->count()}}</span>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 column-divider-sm">
                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('admin.orders.list',['confirmed'])}}'">
                        <div class="media-body">
                            ...
                            <span class="card-title h3">{{\App\Model\Order::where(['order_status'=>'confirmed'])->whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->count()}}</span>
                        </div>
                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                ...
                <div class="col-sm-6 col-lg-3 column-divider-lg">
                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('admin.orders.list',['processing'])}}'">
                        <div class="media-body">
                            ...
                            <span class="card-title h3">{{\App\Model\Order::where(['order_status'=>'processing'])->whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->count()}}</span>
                        </div>
                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                ...
                <div class="col-sm-6 col-lg-3 column-divider-sm">
                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('admin.orders.list',['out_for_delivery'])}}'">
                        <div class="media-body">
                            ...
                            <span class="card-title h3">{{\App\Model\Order::where(['order_status'=>'out_for_delivery'])->whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->count()}}</span>
                        </div>
                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                          <i class="tio-bike"></i>
                        </span>
                ...
                <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['status'=>'delivered'])}}">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2 mb-1">
                            <div class="col-6">
                                <span
                                    class="card-title h2">{{\App\Model\Order::where(['order_status'=>'delivered'])->whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->count()}}</span>
                            </div>
                ...
                <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['status'=>'returned'])}}">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2 mb-1">
                            <div class="col-6">
                                <span
                                    class="card-title h2">{{\App\Model\Order::where(['order_status'=>'returned'])->whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->count()}}</span>
                            </div>
                ...
                <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['status'=>'failed'])}}">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2 mb-1">
                            <div class="col-6">
                                <span
                                    class="card-title h2">{{\App\Model\Order::where(['order_status'=>'failed'])->whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->count()}}</span>
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm mb-2 mb-sm-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span
                                        class="h1 mb-0">{{$amount." ".\App\CentralLogics\Helpers::currency_symbol()}}</span>
