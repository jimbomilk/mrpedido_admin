    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                    <h1 class="page-header-title">{{trans('messages.transaction')}}
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="#">{{trans('messages.transaction')}} {{trans('messages.history')}}</a>
                    </li>
            ...
            <div class="table-responsive datatable-custom pt-2">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th class="table-column-pl-0">{{trans('messages.user')}} {{trans('messages.name')}}</th>
                        <th>{{trans('messages.description')}}</th>
                        <th>{{trans('messages.type')}}</th>
                        <th style="width: 100px"
                            class="text-center">{{trans('messages.amount')}} {{trans('messages.order')}}</th>
                    </tr>
                    </thead>
                    ...
                    @foreach($transition as $key=>$trans)
                        <tr class="">
                            <td class="">
                                {{$key+($transition->currentPage()*10)-9}}
                            </td>
                            <td class="">
