                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">{{trans('messages.customer')}} {{trans('messages.details')}}</li>
                        </ol>
                    </nav>

                    <div class="d-sm-flex align-items-sm-center">
                        <h1 class="page-header-title">{{trans('messages.customer')}} {{trans('messages.id')}}
                            #{{$customer['id']}}</h1>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th style="width: 50%"
                                    class="text-center">{{trans('messages.order')}} {{trans('messages.id')}}</th>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title h4" id="mySmallModalLabel"> {{trans('messages.add')}} {{trans('messages.point')}} </h5>
