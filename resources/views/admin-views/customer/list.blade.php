                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="#">{{trans('messages.customer')}} {{trans('messages.list')}}</a>
                    </li>
                    {{--<li class="nav-item">
                                ...
                                <div id="showHideDropdown"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span
                                                    class="mr-2">{{trans('messages.total')}} {{trans('messages.order')}}</span>
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th>{{trans('messages.available')}} {{trans('messages.points')}}</th>
