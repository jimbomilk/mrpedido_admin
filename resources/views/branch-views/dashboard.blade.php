                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('branch.orders.list',['pending'])}}'">
                        <div class="media-body">
                            ...
                            <span class="card-title h3">{{\App\Model\Order::whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->where(['order_status'=>'pending','branch_id'=>auth('branch')->id()])->count()}}</span>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 column-divider-sm">
                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('branch.orders.list',['confirmed'])}}'">
                        <div class="media-body">
                            ...
                            <span class="card-title h3">{{\App\Model\Order::whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->where(['order_status'=>'confirmed','branch_id'=>auth('branch')->id()])->count()}}</span>
                        </div>
                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                ...
                <div class="col-sm-6 col-lg-3 column-divider-lg">
                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('branch.orders.list',['processing'])}}'">
                        <div class="media-body">
                            ...
                            <span class="card-title h3">{{\App\Model\Order::whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->where(['order_status'=>'processing','branch_id'=>auth('branch')->id()])->count()}}</span>
                        </div>
                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                ...
                <div class="col-sm-6 col-lg-3 column-divider-sm">
                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('branch.orders.list',['out_for_delivery'])}}'">
                        <div class="media-body">
                            ...
                            <span class="card-title h3">{{\App\Model\Order::whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->where(['order_status'=>'out_for_delivery','branch_id'=>auth('branch')->id()])->count()}}</span>
                        </div>
                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                          <i class="tio-bike"></i>
                        </span>
                ...
                <a class="card card-hover-shadow h-100" href="{{route('branch.orders.list',['status'=>'delivered'])}}">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2 mb-1">
                            <div class="col-6">
                                <span
                                    class="card-title h2">{{\App\Model\Order::whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->where(['order_status'=>'delivered','branch_id'=>auth('branch')->id()])->count()}}</span>
                            </div>
                ...
                <a class="card card-hover-shadow h-100" href="{{route('branch.orders.list',['status'=>'returned'])}}">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2 mb-1">
                            <div class="col-6">
                                <span
                                    class="card-title h2">{{\App\Model\Order::whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->where(['order_status'=>'returned','branch_id'=>auth('branch')->id()])->count()}}</span>
                            </div>
                ...
                <a class="card card-hover-shadow h-100" href="{{route('branch.orders.list',['status'=>'failed'])}}">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2 mb-1">
                            <div class="col-6">
                                <span
                                    class="card-title h2">{{\App\Model\Order::whereDate('delivery_date','<=',\Carbon\Carbon::now()->format('Y-m-d'))->where(['order_status'=>'failed','branch_id'=>auth('branch')->id()])->count()}}</span>
                            </div>
